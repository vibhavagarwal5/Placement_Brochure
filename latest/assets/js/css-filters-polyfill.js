	...
	var polyfilter = {
		...
		process_stylesheets: function(){
			...
			window.setTimeout(function(){
				...
				xmlHttpCheck.open('GET.html', window.polyfilter_scriptpath + 'htc/sepia.htc', true);
						...
						case 'LINK':
							if(stylesheets[i].rel === 'stylesheet'){
								...
								try{
									...
									xmlHttp.open('GET.html', href, true);
